...
void UnityPrintNumberByStyle(const _U_SINT number, const UNITY_DISPLAY_STYLE_T style) {
	if ((style & UNITY_DISPLAY_RANGE_INT) == UNITY_DISPLAY_RANGE_INT) {
		...
		UnityPrintNumberUnsigned(  (_U_UINT)number  &  UnitySizeMask[((_U_UINT)style &
		                           (_U_UINT)0x0F) - 1]  );
	} else {
...
static int UnityCheckArraysForNull(UNITY_INTERNAL_PTR expected, UNITY_INTERNAL_PTR actual,
...
void UnityAssertEqualIntArray(UNITY_INTERNAL_PTR expected,
	...
	if (UnityCheckArraysForNull((UNITY_INTERNAL_PTR)expected, (UNITY_INTERNAL_PTR)actual, lineNumber,
	                            msg) == 1)
	{ return; }
	...
	case UNITY_DISPLAY_STYLE_UINT8:
		while (elements--) {
			...
			ptr_exp = (UNITY_INTERNAL_PTR)((_UPTR)ptr_exp + 1);
			ptr_act = (UNITY_INTERNAL_PTR)((_UPTR)ptr_act + 1);
		}
	...
	case UNITY_DISPLAY_STYLE_UINT16:
		while (elements--) {
			...
			ptr_exp = (UNITY_INTERNAL_PTR)((_UPTR)ptr_exp + 2);
			ptr_act = (UNITY_INTERNAL_PTR)((_UPTR)ptr_act + 2);
		}
	...
	case UNITY_DISPLAY_STYLE_UINT64:
		while (elements--) {
			...
			ptr_exp = (UNITY_INTERNAL_PTR)((_UPTR)ptr_exp + 8);
			ptr_act = (UNITY_INTERNAL_PTR)((_UPTR)ptr_act + 8);
		}
	...
	default:
		while (elements--) {
			...
			ptr_exp = (UNITY_INTERNAL_PTR)((_UPTR)ptr_exp + 4);
			ptr_act = (UNITY_INTERNAL_PTR)((_UPTR)ptr_act + 4);
		}
...
void UnityAssertEqualMemory( UNITY_INTERNAL_PTR expected,
                             ...
                             const char* msg,
                             const UNITY_LINE_TYPE lineNumber) {
	UNITY_PTR_ATTRIBUTE const unsigned char* ptr_exp = (UNITY_PTR_ATTRIBUTE const unsigned char*)
	        expected;
	...
	while (elements--) {
		...
		while (bytes--) {
			...
			ptr_exp = (const unsigned char*)(UNITY_INTERNAL_PTR)((_UPTR)ptr_exp + 1);
			ptr_act = (const unsigned char*)(UNITY_INTERNAL_PTR)((_UPTR)ptr_act + 1);
		}
...
void UnityFailInFile(const char* msg, const UNITY_LINE_TYPE line,
                     const char* file, const UNITY_LINE_TYPE fileLine) {
	UNITY_SKIP_EXECUTION;
	UnityTestResultsBegin(Unity.TestFile, line);
	UnityPrintFail();
