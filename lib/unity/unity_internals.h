...
//-------------------------------------------------------
	...
	#ifndef isinf
		#define isinf(n) 0 /*(((1.0f / f_zero) == n) ? 1 : 0) || (((-1.0f / f_zero) == n) ? 1 : 0)*/
...
void UnityFailInFile(const char* msg, const UNITY_LINE_TYPE line, const char* file,
                     const UNITY_LINE_TYPE fileLine);
...
#define UNITY_TEST_ASSERT_EQUAL_PTR(expected, actual, line, message)                             UnityAssertEqualNumber((_U_SINT)(_UPTR)(expected), (_U_SINT)(_UPTR)(actual), (message), (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_POINTER)
...
#define UNITY_TEST_ASSERT_EQUAL_PTR_ARRAY(expected, actual, num_elements, line, message)         UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(_UPTR*)(expected), (UNITY_INTERNAL_PTR)(_UPTR*)(actual), (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_POINTER)
